...
/**
 * Create a wizard step to help the user set the thank you message for the tip form
 *
 * @since    1.0.0
 * @param    array $wizard_steps All the health checks and wizard steps.
 * @return   array $wizard_steps
 */
function tip_jar_wp_thank_you_message_wizard_step( $wizard_steps ) {

	$saved_settings = get_option( 'tip_jar_wp_settings' );

	$wizard_steps['tip_form_thank_you_message'] = array(
		'priority'        => 900,
		'is_healthy'      => false,
		...
		'unhealthy'       => array(
			'component_data' => array(
				...
				'strings'                             => array(
					'title'       => __( 'Enter your "thank you" message', 'tip-jar-wp' ),
					'description' => __( 'Enter the thank-you message you\'d like to show after a successful tip.', 'tip-jar-wp' ),
				),
				'input_field'                         => array(
...
add_filter( 'tip_jar_wp_health_checks_and_wizard_vars', 'tip_jar_wp_thank_you_message_wizard_step' );
